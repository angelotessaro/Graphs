...
void remove_topologica(int ord_topologica[], int vertice){
	int size = sizeof ord_topologica / sizeof ord_topologica[0];
	for(int i = 0; i < len(ord_topologica); i++){
